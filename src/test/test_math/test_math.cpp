...
using namespace CrossEngine::Math;
...
void UnitTest::TestTransformation0()
{
    ...
    EXPECT_VALUES_EQUAL(Trans(3.0f, 1.0f, 2.0f) * vector, (Vec4(4.0f, 3.0f, 5.0f, 1.0f)));
    EXPECT_VALUES_EQUAL(Trans(-20.0f, 3.0f, 0.0f) * vector, (Vec4(-19.0f, 5.0f, 3.0f, 1.0f)));
    EXPECT_VALUES_EQUAL(Scale(3.0f, 1.0f, 2.0f) * vector, (Vec4(3.0f, 2.0f, 6.0f, 1.0f)));
    EXPECT_VALUES_EQUAL(Scale(-20.0f, 3.0f, 0.0f) * vector, (Vec4(-20.0f, 6.0f, 0.0f, 1.0f)));
    auto temp_vec = Pitch(3.0f) * vector;
...
void UnitTest::TestTransformation1()
{
    ...
    EXPECT_VALUES_EQUAL(Trans(3.0f, 1.0f, 2.0f) * direction, direction);
    EXPECT_VALUES_EQUAL(Trans(-20.0f, 3.0f, 0.0f) * direction, direction);
}
void UnitTest::TestTransformation2()
{
    Vec4 vector(1.0f, 2.0f, 3.0f, 1.0f);
    EXPECT_VALUES_EQUAL(ProjOrtho(1.0f, -1.0f, 1.0f, -1.0f, 2.0f, 1.0f) * vector, (Vec4(1.0f, 2.0f, -3.0f, 1.0f)));
    vector = {0.0f, 1.0f, 1.0f, 1.0f};
    EXPECT_VALUES_EQUAL(ProjOrtho(1.0f, -1.0f, 1.0f, -1.0f, 2.0f, 1.0f) * vector, (Vec4(0.0f, 1.0f, 1.0f, 1.0f)));
}
