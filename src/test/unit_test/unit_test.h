...
template<typename T>
concept StringConvertable = std::is_convertible_v<std::remove_reference_t<T>, std::string>;
template<typename T>
concept NStringConvertable = !std::is_convertible_v<std::remove_reference_t<T>, std::string>;
...
private:
     ...
     * @param val_2 Value 2.
     */
    template <StringConvertable T1, StringConvertable T2>
     ...
     * @param val_2 Value 2.
     */
    template <NStringConvertable T1, NStringConvertable T2>
    inline static auto ExpectValuesEqual(const char* p_file, int p_line, T1&& val_1, T2&& val_2)
