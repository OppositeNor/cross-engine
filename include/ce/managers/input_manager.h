...
namespace CrossEngine
{
    ...
    private:
         ...
         */
        void SetInputStatePressed(Window* p_context, Input p_key);
         ...
         * @param p_key The key code.
         */
        void SetInputStateReleased(Window* p_context, Input p_key);
    public:
         ...
         */
        void AddInput(const std::string& input_name, Input p_key);
    ...
    /*
    * Key defs. These defines are copied from glfw3.h.
    * 
